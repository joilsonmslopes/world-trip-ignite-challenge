...
export const citiesByCountry = [
  ...
  },
  {
    ...
    totalLanguages: 199,
    countries: [
      { id: 1, name: 'Afeganistão', flag: '', cities: [] },
      {
        id: 2,
        name: 'Arábia Saudita',
      ...
      { id: 3, name: 'Armênia*', flag: '', cities: [] },
      { id: 4, name: 'Azerbaijão*', flag: '', cities: [] },
      { id: 5, name: 'Bahrein', flag: '', cities: [] },
      { id: 6, name: 'Bangladesh', flag: '', cities: [] },
      { id: 7, name: 'Brunei', flag: '', cities: [] },
      { id: 8, name: 'Butão', flag: '', cities: [] },
      { id: 9, name: 'Camboja', flag: '', cities: [] },
      { id: 10, name: 'Cazaquistão', flag: '', cities: [] },
      { id: 11, name: 'Catar', flag: '', cities: [] },
      {
        id: 12,
        name: 'China',
      ...
      { id: 15, name: 'Coreia do Norte', flag: '', cities: [] },
      {
        id: 16,
        name: 'Coreia do Sul',
      ...
      { id: 20, name: 'Geórgia*', flag: '', cities: [] },
      { id: 21, name: 'Iêmen', flag: '', cities: [] },
      {
        id: 22,
        name: 'Índia',
      ...
      { id: 24, name: 'Irã', flag: '', cities: [] },
      { id: 25, name: 'Iraque', flag: '', cities: [] },
      {
        id: 26,
        name: 'Israel',
      ...
      { id: 28, name: 'Jordânia', flag: '', cities: [] },
      { id: 29, name: 'Kuwait', flag: '', cities: [] },
      { id: 30, name: 'Laos', flag: '', cities: [] },
      { id: 31, name: 'Líbano', flag: '', cities: [] },
      {
        id: 32,
        name: 'Malásia',
      ...
      { id: 33, name: 'Maldivas', flag: '', cities: [] },
      { id: 34, name: 'Mianmar', flag: '', cities: [] },
      { id: 35, name: 'Mongólia', flag: '', cities: [] },
      { id: 36, name: 'Nepal', flag: '', cities: [] },
      { id: 37, name: 'Omã', flag: '', cities: [] },
      { id: 38, name: 'Paquistão', flag: '', cities: [] },
      { id: 39, name: 'Quirguistão', flag: '', cities: [] },
      { id: 40, name: 'Rússia*', flag: '', cities: [] },
      { id: 41, name: 'Síria', flag: '', cities: [] },
      { id: 42, name: 'Sri Lanka', flag: '', cities: [] },
      { id: 43, name: 'Tajiquistão', flag: '', cities: [] },
      {
        id: 44,
        name: 'Tailândia',
      ...
      { id: 45, name: 'Timor-Leste*', flag: '', cities: [] },
      { id: 46, name: 'Turcomenistão', flag: '', cities: [] },
      {
        id: 47,
        name: 'Turquia',
      ...
      { id: 48, name: 'Uzbequistão', flag: '', cities: [] },
      {
        id: 49,
        name: 'Vietnã',
